...
export const SecondChance: React.FC<SecondChanceProps> = ({ onBack }) => {
  ...
  const handleAnswer = async (questionId: string, answer: string, question: Question) => {
    ...
    return (
      <div className="w-full max-w-4xl px-4 py-8 relative">
        ...
        <div className="text-center mt-16">
          <h2 className="text-2xl font-bold text-blue-600 mb-4">Andra chansen</h2>
