...
export const Calculator = ({ onClose }) => {
  ...
  return (
    <div 
      className="bg-gray-100 p-4 rounded-xl shadow-lg backdrop-blur-sm z-40 min-w-[240px]"
      onClick={e => e.stopPropagation()}
    >
      <div className="bg-white p-2 rounded mb-1 text-right text-sm text-gray-600">
        {expression || '\u00A0'}
      </div>
      <div className="bg-white p-2 rounded mb-2 text-right text-xl font-bold">
        {display}
      </div>
